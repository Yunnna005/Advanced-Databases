...
export default function MenuItem({title, description,price, imageUrl, onAddToOrder}: MenuItemProps) {
    return (
        <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-100 dark:border-gray-200">
            ...
            <div className="p-5 text-left">
                ...
                <button type="button" onClick={onAddToOrder} className="text-white bg-blue-900 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 cursor-pointer dark:bg-blue-900 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add to Order</button>
            </div>
        </div>
    );
}