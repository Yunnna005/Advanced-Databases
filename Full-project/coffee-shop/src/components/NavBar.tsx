export default function NavBar() {
    return (
        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-stone-800 rounded-lg bg-stone-800 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                <li>
                <a href="#" className="block py-2 px-3 text-white bg-stone-800 rounded-sm md:bg-transparent md:text-stone-800 md:p-0 dark:text-white md:dark:text-stone-800" aria-current="page">Home</a>
                </li>
                <li>
