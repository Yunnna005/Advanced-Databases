...
export default function Menu() {
    return (
        ...
        <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl lg:text-6xl">Our Menu</h1>
        <p className="mb-8 text-lg font-normal lg:text-xl sm:px-16 xl:px-48">Explore our diverse menu of expertly crafted coffee beverages, from classic espresso to innovative seasonal specials, all made with the finest ethically sourced beans.</p>
